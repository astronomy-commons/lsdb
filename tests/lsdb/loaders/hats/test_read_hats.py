...
def test_read_hats_npix_alt_suffix(
    small_sky_npix_alt_suffix_dir, small_sky_npix_alt_suffix_hats_catalog, assert_divisions_are_correct
):
...
def test_read_hats_npix_as_dir(
    small_sky_npix_as_dir_dir, small_sky_npix_as_dir_hats_catalog, assert_divisions_are_correct
):
