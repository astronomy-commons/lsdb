...
class Helpers:
    ...
    def assert_hive_columns_correct(cat: HealpixDataset):
        for pixel in cat.get_healpix_pixels():
            ...
            assert np.any(partition[paths.PARTITION_PIXEL].isna()) is False
