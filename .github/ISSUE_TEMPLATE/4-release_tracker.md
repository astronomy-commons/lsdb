...
- [ ] confirm new version exists in `mamba search hats -c conda-forge --override-channels` (or conda search, which is slower)
...
- [ ] confirm new version exists in `mamba search hats-import -c conda-forge --override-channels` (or conda search, which is slower)
