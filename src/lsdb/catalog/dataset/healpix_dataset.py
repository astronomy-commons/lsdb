...
class HealpixDataset(Dataset):
    ...
    def nest_lists(
        ...
        Args:
            base_columns (list-like or None): Any columns that have non-list values in the input catalog. These will
        ...
        return self.__class__(new_ddf, self._ddf_pixel_map, self.hc_structure)
