...
class AbstractCrossmatchAlgorithm(ABC):
    ...
    @classmethod
    def validate(cls, left: Catalog, right: Catalog, how: PixelAlignmentType = PixelAlignmentType.INNER):
    ...
    def _create_crossmatch_df(
        ...
        right_join_part = self._generate_right_join_part(right_idx, extra_cols)
