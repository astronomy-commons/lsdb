...
class AbstractCrossmatchAlgorithm(ABC):
    ...
    def _append_extra_columns(self, dataframe: pd.DataFrame, extra_columns: pd.DataFrame | None = None):
        ...
        for col, col_type in extra_columns.dtypes.items():
        ...
        for col, col_type in self.extra_columns.dtypes.items():
